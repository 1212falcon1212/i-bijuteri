...
interface AuthContextType {
  ...
  login: (email: string, password: string, revoke_others?: boolean) => Promise<{ success: boolean; error?: string }>;
  logout: () => Promise<void>;
...
const PUBLIC_ROUTE_PREFIXES = ['/sayfa/', '/sayfalar/'];
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = async (email: string, password: string, revoke_others = false) => {
    const response = await authApi.login(email, password, revoke_others);
