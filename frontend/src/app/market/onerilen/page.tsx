    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex items-center gap-2 text-sm text-charcoal-light dark:text-charcoal-light mb-6">
                ...
                <span className="text-charcoal dark:text-white font-medium">Sizin İçin Önerilen</span>
            </div>
            ...
            <div className="page-head">
                <div className="l">
                    <span className="eyebrow inline-flex items-center gap-3">
                        <span className="gold-rule" /> Size Özel
                    </span>
                    <h1>Sizin için önerilen.</h1>
                    <div className="sub">
                        <b>{totalProducts}</b> ürün · Beğenilerinize ve geçmişinize göre seçildi
                    </div>
                </div>
                <div className="r">
                    <button
                        type="button"
                        className="inline-flex items-center gap-2 text-[var(--ink)] hover:text-[var(--accent-2)] border-b border-[var(--ink)] hover:border-[var(--accent-2)] pb-0.5 text-[12px] uppercase tracking-[.14em] font-semibold"
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[#B89968]" />
                    <span className="text-charcoal-mid dark:text-charcoal-light">Her yenilemede farklı ürünler</span>
                </div>
            ...
            <div className="flex gap-6">
                ...
                <aside className="hidden lg:block w-60 flex-shrink-0">
                    <div className="sticky top-20 bg-white dark:bg-charcoal rounded-xl border border-black/10 dark:border-slate-700">
                        <div className="px-5 py-3 border-b border-black/5 dark:border-white/5 bg-gradient-to-r from-[#F1E6D0]/80 to-[#FBF8F3]/50 dark:from-[#8C6F3F]/20 dark:to-[#7A4853]/10 rounded-t-xl">
