...
function AllProductsContent() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            {/* Breadcrumb */}
            <div className="crumbs px-0">
                <Link href="/market" className="a">
                    Pazaryeri
                </Link>
                <span className="sep">›</span>
                <span className="now">Tüm Ürünler</span>
            </div>

            <div className="page-head px-0">
                <div className="l">
                    <span className="eyebrow inline-flex items-center gap-3">
                        <span className="gold-rule" /> Pazaryeri · Tüm
                    </span>
                    <h1>Tüm Ürünler.</h1>
                    <div className="sub">
                        <b>{totalProducts}</b> ürün · Tüm kategorilerden
                    </div>
                </div>
                <div className="r">
                    Pazaryerimizdeki tüm aktif ürünleri tek listede görün. Kategori, marka ve
                    fiyat filtrelerini kullanarak daraltın.
                </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    <Box className="w-5 h-5 text-[var(--accent-2)]" />
                    <span className="text-charcoal-mid dark:text-charcoal-light">
