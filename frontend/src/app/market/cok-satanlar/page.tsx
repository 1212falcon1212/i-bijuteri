    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex items-center gap-2 text-sm text-charcoal-light dark:text-charcoal-light mb-6">
                <Link href="/market" className="hover:text-[var(--accent-2)] transition-colors">
                    Pazaryeri
                </Link>
                <ChevronRight className="w-4 h-4" />
                <span className="text-charcoal dark:text-white font-medium">Çok Satanlar</span>
            </div>
            ...
            <div className="page-head">
                <div className="l">
                    <span className="eyebrow inline-flex items-center gap-3">
                        <span className="gold-rule" /> Pazaryeri · Trend
                    </span>
                    <h1>Çok Satanlar.</h1>
                    <div className="sub">
                        <b>{totalProducts}</b> ürün · Teklif sayısına göre sıralı
                    </div>
                </div>
                <div className="r">
                    Bu sezonun en çok tercih edilen ürünleri. Tedarikçilerden gelen ilgi ve sipariş
                    yoğunluğuna göre sıralanır.
                </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    <Flame className="w-5 h-5 text-[#B89968]" />
                    <span className="text-charcoal-mid dark:text-charcoal-light">Teklif sayısına göre sıralanmış</span>
                </div>
                <Sheet open={mobileFilterOpen} onOpenChange={setMobileFilterOpen}>
                    <SheetTrigger asChild>
                        <Button variant="outline" className="lg:hidden gap-2">
                            ...
                            Filtrele
                            {hasActiveFilters && <span className="w-2 h-2 rounded-full bg-[var(--ink)]" />}
                        </Button>
                    </SheetTrigger>
            ...
            {hasActiveFilters && (
                <div className="flex flex-wrap items-center gap-2 mb-6">
                    ...
                    {filters.brand && (
                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-[var(--accent-soft)] dark:bg-[var(--accent-soft)] text-[var(--accent-2)] dark:text-[var(--accent)] text-xs font-medium rounded-full">
                            Marka: {filters.brand}
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 p-3">
                            {products.map((product, index) => (
                                <div key={product.id} className="relative">
                                    {index < 3 && (
                                        <div className="absolute top-2 left-2 z-10 w-7 h-7 bg-gradient-to-br from-amber-500 to-[#8C6F3F] rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">
                                            {index + 1}
                                        </div>
                                    )}
