        ...
        <div className="relative" ref={ref}>
            <div
                ...
                className={cn(
                    ...
                    isOpen
                        ? 'border-[#B89968] ring-2 ring-[#B89968]/20 bg-white'
                        : 'border-[#e5e1de] bg-white hover:border-[#B89968]',
                    !displayValue && 'text-[#9ca3af]'
                )}
            >
                <Calendar className="w-4 h-4 text-[#B89968] mr-2.5 flex-shrink-0" />
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        disabled
                                            ...
                                            : selected
                                                ? 'bg-[#B89968] text-white shadow-sm'
...
function PriceComparison({ entered, lowest }: { entered: number; lowest: number }) {
    ...
    return (
        <div className="flex items-center gap-1.5 text-charcoal-light bg-surface-bg border border-card-border rounded-lg px-2.5 py-1.5">
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        <Link
                            ...
                            className="flex items-center justify-center w-9 h-9 rounded-xl border border-[#e5e1de] hover:border-[#B89968] hover:text-[#B89968] text-[#6b7280] transition-all"
                        >
                    ...
                    <Button
                        ...
                        className="bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl font-bold px-5 h-10 disabled:opacity-50"
                    >
                        {isSubmitting ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                            ...
                            <div className="bg-white rounded-2xl border border-[#e5e1de] overflow-hidden">
                                <div className="px-5 py-4 border-b border-[#f0eceb] flex items-center gap-2.5">
                                    <div className="w-7 h-7 rounded-lg bg-[#F1E6D0] flex items-center justify-center">
                                        <Package className="w-3.5 h-3.5 text-[#B89968]" />
                                    </div>
                                    <div>
                                ...
                                <div className="p-5">
                                    {!selectedProduct ? (
                                        <div className="space-y-3">
                                            ...
                                            <div className="inline-flex rounded-xl bg-[#f7f4f2] p-1 border border-[#e5e1de]">
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        searchMode === 'name'
                                                            ? 'bg-white text-[#B89968] shadow-sm'
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={cn(
                                                        "w-full h-11 pl-10 rounded-xl border bg-[#faf8f6] text-sm placeholder:text-[#9ca3af] focus:outline-none focus:border-[#B89968] focus:ring-2 focus:ring-[#B89968]/20 focus:bg-white transition-all",
                                                        searchMode === 'barcode' ? 'border-[#B89968]/30 font-mono tracking-wider pr-20' : 'border-[#e5e1de] pr-10'
                                                    )}
                                                    autoFocus
                                                    key={searchMode}
                                                />
                                                {searchMode === 'barcode' && (
                                                    <button
                                                        ...
                                                        className="absolute top-1/2 -translate-y-1/2 right-10 h-8 w-8 rounded-lg bg-white border border-[#B89968]/30 text-[#B89968] hover:bg-[#F1E6D0] transition-colors flex items-center justify-center"
                                                    >
                                                        <ScanLine className="w-4 h-4" />
                                                    </button>
                                                )}
                                                {isSearching && (
                                                    <Loader2 className="w-4 h-4 absolute right-3.5 top-1/2 -translate-y-1/2 animate-spin text-[#B89968]" />
                                                )}
                                            </div>
                                            ...
                                            {searchResults.length > 0 && (
                                                <div className="border border-[#e5e1de] rounded-xl overflow-hidden divide-y divide-[#f0eceb]">
                                                    {searchResults.map((product) => (
                                                        ...
                                                        >
                                                            <div className="w-11 h-11 rounded-xl bg-[#faf8f6] border border-[#f0eceb] overflow-hidden flex items-center justify-center flex-shrink-0 group-hover:border-[#B89968]/30 transition-colors">
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                <p className="text-sm font-semibold text-[#1a1a1a] truncate group-hover:text-[#B89968] transition-colors">
                                                                    {product.name}
                                                                </p>
                                                                <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                                                                    ...
                                                                    {product.brand && (
                                                                        <span className="text-[11px] text-[#B89968] font-bold uppercase">
                                                                            {product.brand}
                                                                        </span>
                                                                    )}
                                                                </div>
                                                            ...
                                                            <div className="flex-shrink-0 text-right">
                                                                {product.lowest_price != null && product.lowest_price > 0 ? (
                                                                    <div>
                                                                        <p className="text-sm font-bold text-[#B89968]">
                                            ...
                                            {searchQuery.length < (searchMode === 'barcode' ? 1 : 2) && (
                                                <div className="text-center py-10">
                                                    <div className="w-14 h-14 rounded-2xl bg-[#F1E6D0] border border-[#b2e8f3] flex items-center justify-center mx-auto mb-3">
                                                        {searchMode === 'barcode' ? (
                                                            <ScanBarcode className="w-6 h-6 text-[#B89968]" />
                                                        ) : (
                                                            <Search className="w-6 h-6 text-[#B89968]" />
                                                        )}
                                                    </div>
                                                    <p className="text-sm font-semibold text-[#6b7280]">
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-xl border-2 border-[#B89968]/20 bg-gradient-to-br from-[#F1E6D0] to-white p-4 flex items-start gap-4">
                                                <div className="w-16 h-16 rounded-xl bg-white border border-[#e5e1de] overflow-hidden flex items-center justify-center flex-shrink-0 shadow-sm">
                                                    {(selectedProduct.image_url || selectedProduct.image) ? (
                                                        ...
                                                        <Package className="w-7 h-7 text-[#B89968]" />
                                                    )}
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {selectedProduct.lowest_price != null && selectedProduct.lowest_price > 0 && (
                                                        <div className="flex items-center gap-1.5 mt-2">
                                                            <BarChart3 className="w-3.5 h-3.5 text-[#B89968]" />
                                                            <p className="text-xs text-[#6b7280]">
                                                                En düşük fiyat:{' '}
                                                                <span className="font-bold text-[#B89968]">
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => setSelectedProduct(null)}
                                                className="text-xs text-[#B89968] hover:underline flex items-center gap-1"
                                            >
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full h-11 pl-4 pr-10 rounded-xl border border-[#e5e1de] bg-white text-sm font-semibold text-[#1a1a1a] placeholder:text-[#9ca3af] placeholder:font-normal focus:outline-none focus:border-[#B89968] focus:ring-2 focus:ring-[#B89968]/20 transition-all"
                                                    />
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <div className="relative">
                                                    <input
                                                        ...
                                                        className="w-full h-11 pl-4 pr-14 rounded-xl border border-[#e5e1de] bg-white text-sm font-semibold text-[#1a1a1a] placeholder:text-[#9ca3af] placeholder:font-normal focus:outline-none focus:border-[#B89968] focus:ring-2 focus:ring-[#B89968]/20 transition-all"
                                                    />
                                                    <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-xs font-bold text-[#9ca3af]">
                                                        adet
                                                    </span>
                        ...
                        <div className="lg:col-span-2 space-y-5">
                                ...
                                <div className="p-5 space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-11 px-4 rounded-xl border border-[#e5e1de] bg-white text-sm text-[#1a1a1a] placeholder:text-[#9ca3af] focus:outline-none focus:border-[#B89968] focus:ring-2 focus:ring-[#B89968]/20 transition-all"
                                        />
                                    </div>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            className="w-full px-4 py-3 rounded-xl border border-[#e5e1de] bg-white text-sm text-[#1a1a1a] placeholder:text-[#9ca3af] focus:outline-none focus:border-[#B89968] focus:ring-2 focus:ring-[#B89968]/20 transition-all resize-none"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl border border-[#e5e1de] overflow-hidden">
                                <div className="px-5 py-4 border-b border-[#f0eceb] flex items-center gap-2.5">
                                    <div className="w-7 h-7 rounded-lg bg-[#F1E6D0] flex items-center justify-center">
                                        <ShoppingCart className="w-3.5 h-3.5 text-[#B89968]" />
                                    </div>
                                ...
                                <div className="p-5 space-y-3">
                                    ...
                                    <Button
                                        type="submit"
                                        disabled={!isFormValid || isSubmitting}
                                        className="w-full bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl font-bold h-11 disabled:opacity-50 mt-1"
                                    >
                                        {isSubmitting ? (
                                            <><Loader2 className="w-4 h-4 mr-2 animate-spin" />Yayınlanıyor...</>
                                        ) : (
