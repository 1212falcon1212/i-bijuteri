...
function MonthYearPicker({
    ...
    return (
        <div className="relative" ref={ref}>
            <div
                className="flex items-center h-9 w-full rounded-xl border border-[#f0eceb] bg-white px-3 text-sm cursor-pointer hover:border-[#B89968] transition-colors"
...
const OFFER_STATUS_COLORS: Record<string, string> = {
    ...
    'active': 'bg-[#F1E6D0] text-[#8C6F3F]',
    'inactive': 'bg-surface-bg text-charcoal-mid',
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                    <div className="relative flex-1 sm:flex-none">
                        ...
                        <Input
                            ...
                            className="pl-9 w-full sm:w-64 border-[#f0eceb] rounded-xl focus:border-[#B89968] focus:ring-[#B89968]"
                        />
                    </div>

                    <Link href="/market/hesabim/ilanlarim/yeni">
                        <Button className="bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl font-semibold w-full sm:w-auto">
                        ...
                        <DialogContent className="sm:max-w-[540px] max-h-[90vh] flex flex-col p-0 gap-0 overflow-hidden rounded-2xl border-[#f0eceb]">
                            ...
                            <div className="px-5 pt-5 pb-3 border-b border-[#f0eceb] bg-white flex-shrink-0">
                                <DialogHeader>
                                    <DialogTitle className="text-lg font-black text-[#1a1a1a] flex items-center gap-2">
                                        {editingOffer ? (
                                            <><Edit className="w-4 h-4 text-[#B89968]" /> İlanı Düzenle</>
                                        ) : (
                                            <><Plus className="w-4 h-4 text-[#B89968]" /> Yeni İlan Oluştur</>
                                        )}
                                    </DialogTitle>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className="pl-9 h-10 bg-[#faf8f6] border-[#f0eceb] rounded-xl focus:bg-white focus:border-[#B89968] focus:ring-[#B89968] transition-colors"
                                                autoFocus
                                            />
                                            {isSearching && (
                                                <Loader2 className="w-4 h-4 absolute right-3 top-1/2 -translate-y-1/2 animate-spin text-[#B89968]" />
                                            )}
                                        </div>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex-1 min-w-0">
                                                                ...
                                                                <div className="flex items-center gap-2 mt-0.5">
                                                                    ...
                                                                    {product.brand && (
                                                                        <span className="text-[10px] text-[#B89968] uppercase font-semibold">{product.brand}</span>
                                                                    )}
                                                                </div>
                                                            </div>
                                                            <div className="flex-shrink-0 text-right">
                                                                {product.lowest_price != null && product.lowest_price > 0 ? (
                                                                    <div>
                                                                        <p className="text-xs font-semibold text-[#B89968]">{formatPrice(product.lowest_price)}</p>
                                        ...
                                        <div className="rounded-2xl border border-[#f0eceb] bg-[#faf8f6] overflow-hidden">
                                            <div className="p-3 flex items-center gap-3">
                                                {(selectedProduct.image_url || selectedProduct.image) ? (
                                                    ...
                                                    <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center flex-shrink-0 border border-[#f0eceb]">
                                                        <Package className="w-5 h-5 text-[#B89968]" />
                                                    </div>
                                                )}
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex items-center gap-2 mt-0.5">
                                                        ...
                                                        {selectedProduct.brand && (
                                                            <span className="text-[10px] text-[#B89968] uppercase font-semibold">{selectedProduct.brand}</span>
                                                        )}
                                                    </div>
                                                </div>
                                                {!editingOffer && (
                                            ...
                                            {selectedProduct.lowest_price != null && selectedProduct.lowest_price > 0 && (
                                                <div className="px-3 py-2 border-t border-[#f0eceb] bg-white flex items-center gap-2">
                                                    <TrendingDown className="w-3.5 h-3.5 text-[#B89968] flex-shrink-0" />
                                                    <p className="text-xs text-[#6b7280]">
                                                        En dusuk fiyat: <span className="font-bold text-[#B89968]">{formatPrice(selectedProduct.lowest_price)}</span>
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="relative">
                                                        <Input
                                                            ...
                                                            className="h-10 pr-9 border-[#f0eceb] rounded-xl focus:border-[#B89968] focus:ring-[#B89968]"
                                                        />
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <div className="relative">
                                                        <Input
                                                            ...
                                                            className="h-10 pr-12 border-[#f0eceb] rounded-xl focus:border-[#B89968] focus:ring-[#B89968]"
                                                        />
                                            ...
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <Input
                                                        ...
                                                        className="h-9 border-[#f0eceb] rounded-xl focus:border-[#B89968] focus:ring-[#B89968]"
                                                    />
                                                </div>
                                            </div>
                            ...
                            <div className="px-5 py-3 border-t border-[#f0eceb] bg-[#faf8f6] flex items-center justify-end gap-2 flex-shrink-0">
                                ...
                                <Button
                                    ...
                                    className="bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl font-semibold min-w-[120px]"
                                >
                                    {isSubmitting ? (
                                        <>
                    ...
                    {offers.map((offer) => (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                {offer.product?.brand && (
                                    <p className="text-xs text-[#B89968] uppercase font-semibold mt-0.5">{offer.product.brand}</p>
                                )}
                            ...
                            <div className="flex flex-col items-end gap-2 flex-shrink-0">
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <button
                                        ...
                                        className="p-1.5 rounded-lg hover:bg-[#faf8f6] text-[#6b7280] hover:text-[#B89968] transition-colors"
                                        title="Duzenle"
                                    >
