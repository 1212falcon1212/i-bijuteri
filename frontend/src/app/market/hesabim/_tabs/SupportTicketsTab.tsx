...
const STATUS_COLORS: Record<string, string> = {
    ...
    waiting: 'bg-[#F1E6D0] text-[#B89968]',
    resolved: 'bg-[#F1E6D0] text-[#8C6F3F]',
                    ...
                    {files.map((file, i) => (
                        <div key={i} className="flex items-center gap-1.5 bg-[#faf8f6] border border-[#f0eceb] rounded-xl px-2.5 py-1.5 text-xs text-[#1a1a1a]">
                            {file.type.startsWith('image/') ? (
                                ...
                                <FileText className="w-3.5 h-3.5 text-[#B89968] shrink-0" />
                            )}
                ...
                return (
                    <a
                        ...
                        className={`flex items-center gap-1.5 rounded-xl px-2.5 py-1.5 text-xs transition border ${
                            isStaff
                                ? 'bg-white border-[#f0eceb] text-[#1a1a1a] hover:border-[#D4B896]'
                                : 'bg-[#faf8f6] border-[#f0eceb] text-[#1a1a1a] hover:border-[#D4B896]'
                        }`}
                    >
        ...
        <div className="space-y-3">
            {tickets.map(ticket => (
                <button
                    ...
                    className="w-full text-left bg-white border border-[#f0eceb] rounded-2xl p-4 hover:border-[#D4B896] transition-colors"
                >
                            ...
                            {ticket.last_message && (
                                <p className="text-xs text-[#6b7280] truncate">
                                    {ticket.last_message.is_staff_reply && (
                                        <span className="text-[#B89968] font-medium">Destek: </span>
                                    )}
                            ...
                            <div className="flex items-center justify-between mb-1">
                                {msg.is_staff_reply ? (
                                    <div className="flex items-center gap-1.5">
                                        <Headphones className="w-3.5 h-3.5 text-[#B89968]" />
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            className="shrink-0 bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl h-auto min-h-[60px]"
                        >
    ...
    if (submitted) {
        return (
            <div className="text-center py-16 max-w-md mx-auto">
                <div className="w-16 h-16 mx-auto bg-[#F1E6D0] rounded-2xl flex items-center justify-center mb-4">
                    <CheckCircle2 className="w-8 h-8 text-[#B89968]" />
                </div>
                ...
                <Button onClick={onCreated} className="bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl">
                    Taleplerime Git
                </Button>
            </div>
        );
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
            ...
            <div>
                ...
                <select
                    ...
                    className="mt-1.5 w-full rounded-xl border border-[#f0eceb] bg-white px-3 py-2 text-sm text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#D4B896] focus:border-[#D4B896]"
                    required
                >
            ...
            <Button
                ...
                className="bg-[#B89968] hover:bg-[#8C6F3F] text-white rounded-xl w-full font-semibold"
            >
                {submitting ? (
                    <>
