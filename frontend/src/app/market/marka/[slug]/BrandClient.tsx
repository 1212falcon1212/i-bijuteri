...
function MarketBrandContent() {
        ...
        <div className="space-y-5">
            ...
            <div className="pt-4 border-t border-black/5 dark:border-white/5">
                ...
                <Button
                    variant="outline"
                    size="sm"
                    className="w-full mt-2 h-8 text-xs bg-[#F1E6D0] text-[#B89968] border-[#D4B896] hover:bg-[#8C6F3F] dark:bg-[#8C6F3F]/30 dark:text-[#D4B896] dark:border-[#8C6F3F] dark:hover:bg-[#8C6F3F]/50"
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            {/* Breadcrumb */}
            <div className="flex items-center gap-2 text-sm text-charcoal-light dark:text-charcoal-light mb-6">
                ...
                <ChevronRight className="w-4 h-4" />
                <span className="text-charcoal dark:text-white font-medium">{brandName}</span>
            </div>

            {/* Brand Header */}
            <div className="bg-white dark:bg-charcoal rounded-lg border border-card-border dark:border-slate-700 p-6 mb-6">
                <div className="flex items-center gap-6">
                    {/* Brand Logo */}
                    <div className="w-20 h-20 bg-surface-bg dark:bg-slate-700 rounded-xl flex items-center justify-center flex-shrink-0">
                        {brandInfo?.logo ? (
                            <img
                                src={brandInfo.logo}
                                alt={brandName}
                            ...
                            <Building2 className="w-10 h-10 text-charcoal-light" />
                        )}
                    </div>

                    {/* Brand Info */}
                    <div className="flex-1">
                        <h1 className="text-2xl sm:text-3xl font-bold text-charcoal dark:text-white mb-1">
                            {brandName}
                        </h1>
                        {brandInfo?.description && (
                            <p className="text-charcoal-light dark:text-charcoal-light text-sm mb-2">
                                {brandInfo.description}
                            </p>
                        )}
                        <p className="text-charcoal-mid dark:text-charcoal-light">
            ...
            {hasActiveFilters && (
                <div className="flex flex-wrap items-center gap-2 mb-6">
                    <span className="text-sm text-charcoal-light">Aktif filtreler:</span>
                    {filters.category && (
                    ...
                    {filters.sortBy !== 'offers_count' && (
                        <span className="inline-flex items-center gap-1 px-2 py-1 bg-surface-bg dark:bg-charcoal text-charcoal-mid dark:text-charcoal-light text-xs font-medium rounded-full">
            ...
            <div className="flex gap-6">
                ...
                <aside className="hidden lg:block w-60 flex-shrink-0">
                    <div className="sticky top-20 bg-white dark:bg-charcoal rounded-xl border border-black/10 dark:border-slate-700">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-16 px-4">
                            <Box className="h-16 w-16 text-charcoal-light dark:text-charcoal-mid mb-4" />
                            ...
                            <p className="text-charcoal-light dark:text-charcoal-light mb-4 text-center">
                                {hasActiveFilters
                        ...
                        <div className="py-6">
                            ...
                            {isLoadingMore && (
                                <div className="flex justify-center items-center gap-2 py-4">
                                    <div className="h-5 w-5 animate-spin rounded-full border-2 border-card-border border-t-slate-600 dark:border-slate-600 dark:border-t-slate-300" />
                            ...
                            {!hasMore && !isLoadingMore && (
                                <p className="text-center text-sm text-charcoal-light dark:text-charcoal-light py-2">
    ...
    return (
        <Suspense fallback={
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div className="bg-white dark:bg-charcoal rounded-xl border border-black/10 dark:border-slate-700 overflow-hidden">
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 p-3">
                        {[...Array(8)].map((_, i) => (
                            <Skeleton key={i} className="h-[120px] rounded-2xl" />
                        ))}
