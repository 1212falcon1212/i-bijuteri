...
export async function generateMetadata({
  ...
  const description =
    ...
    `${categoryName} urunlerini en uygun fiyatlarla i-Bijuteri'da bulun`;

  return {
    title: `${categoryName} | i-Bijuteri`,
    description,
    openGraph: {
      title: `${categoryName} | i-Bijuteri`,
      description,
      type: 'website',
      siteName: 'i-Bijuteri',
      url: `https://i-bijuteri.com/market/category/${fullSlug}`,
    },
    twitter: {
      card: 'summary',
      title: `${categoryName} | i-Bijuteri`,
    ...
    alternates: {
      canonical: `https://i-bijuteri.com/market/category/${fullSlug}`,
    },
  };
}
