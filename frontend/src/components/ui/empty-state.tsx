    ...
    return (
        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
            ...
            <div className="relative mb-6">
                ...
                <div className="relative w-24 h-24 bg-gradient-to-br from-blue-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-full flex items-center justify-center border border-card-border dark:border-slate-700">
            ...
            <p className="text-charcoal-light dark:text-charcoal-light max-w-md mb-6">
                {displayDescription}
            </p>
