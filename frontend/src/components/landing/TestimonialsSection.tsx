...
export default function TestimonialsSection({
  ...
  return (
    <section
      id="referanslar"
      className="py-24 lg:py-32 bg-gradient-to-b from-[#F1E6D0] via-[#FBF8F3]/30 to-white relative overflow-hidden"
    >
      {/* Background decorations */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#D4B896]/25 rounded-full blur-3xl" />
      <div className="absolute bottom-20 right-10 w-64 h-64 bg-[#C9A961]/15 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-[#B89968] text-sm font-semibold mb-5 shadow-sm">
          ...
          {items.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-2xl p-7 shadow-sm border border-[#F1E6D0]/70 hover:shadow-lg hover:shadow-[#D4B896]/30 transition-all duration-300 group"
              >
                {/* Quote icon */}
                <div className="absolute top-6 right-6 opacity-[0.06] group-hover:opacity-[0.12] transition-opacity">
                  <Quote className="w-12 h-12 text-[#B89968]" />
                </div>
                ...
                <div className="flex items-center gap-0.5 mb-5">
                  {[...Array(5)].map((_, j) => (
                    <svg
                      key={j}
                      className="w-4 h-4 text-[#C9A961] fill-current"
                      viewBox="0 0 20 20"
                    >
                ...
                {/* Quote */}
                <p className="text-[#6A5F4E] leading-relaxed mb-6 text-[15px]">
                  &ldquo;{item.quote}&rdquo;
                </p>

                {/* Author */}
                <div className="flex items-center gap-3 pt-5 border-t border-[#ECE3D2]">
                  {item.photo ? (
                  ...
                  <div>
                    <div className="font-semibold text-[#1B1611] text-sm">
                      {item.author}
                    </div>
                    <div className="text-xs text-[#9C8E78]">{item.role}</div>
                  </div>
                </div>
              </motion.div>
            );
        ...
        <div className="md:hidden">
          <div className="relative overflow-hidden">
            <motion.div
              ...
              className="bg-white rounded-2xl p-7 shadow-sm border border-[#F1E6D0]/70"
            >
              <div className="flex items-center gap-0.5 mb-5">
                {[...Array(5)].map((_, j) => (
                  <svg
              ...
              <p className="text-[#6A5F4E] leading-relaxed mb-6">
              ...
              <div className="flex items-center gap-3 pt-5 border-t border-[#ECE3D2]">
                ...
                <div>
                  ...
                  <div className="text-xs text-[#9C8E78]">
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              onClick={prev}
              className="p-2 rounded-full bg-white border border-[#ECE3D2] text-[#9C8E78] hover:text-[#B89968] hover:border-[#D4B896] transition-colors shadow-sm"
              aria-label="Onceki"
            >
              ...
              {items.map((_, i) => (
                <button
                  ...
                  className={`transition-all duration-300 rounded-full ${
                    i === activeIndex
                      ? "w-8 h-2.5 bg-[#B89968]"
                      : "w-2.5 h-2.5 bg-[#ECE3D2] hover:bg-[#D4B896]"
                  }`}
