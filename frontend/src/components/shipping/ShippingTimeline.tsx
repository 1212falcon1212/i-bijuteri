                ...
                <div className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                    ...
                    {trackingUrl && (
                        <a
                            ...
                            className="text-[#B89968] hover:underline text-sm"
                        >
                            Takip Et →
                        </a>
                    )}
                            ...
                            <div key={step.status} className="relative flex items-start gap-4 pl-8">
                                ...
                                <div
                                    className={`absolute left-0 w-8 h-8 rounded-full flex items-center justify-center ${isCompleted
                                            ? 'bg-[#FBF8F3] text-white'
                                            : isCurrent
                                                ? 'bg-[#FBF8F3] text-[#B89968] ring-2 ring-[#B89968]'
                                ...
                                <div className="flex-1 min-w-0 pb-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {isCurrent && (
                                            <Badge variant="secondary" className="bg-[#FBF8F3] text-[#B89968]">
                                                Şu an
                                            </Badge>
                                        )}
                                    </div>
