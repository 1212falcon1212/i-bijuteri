        ...
        <section className="py-4">
            <div className="bg-white -mx-4 sm:-mx-7 px-4 sm:px-7 border-y border-[#f0eceb] py-12">
                <div className="flex items-center justify-between mb-6 pb-6 border-b border-[#f0eceb]">
                    ...
                    <Link href="/market/products" className="group flex items-center gap-1.5 text-sm font-semibold border-[1.5px] border-[#D4B896] text-[#B89968] hover:bg-[#B89968] hover:text-white rounded-[10px] px-4 py-1.5 transition-colors">
                        Tümünü Gör
                ...
                <div className="text-center pt-6 mt-4 border-t border-[#f0eceb]">
                    {hasMore ? (
                        <Button
                            className="bg-[#B89968] text-white hover:bg-[#8C6F3F] rounded-[14px] font-extrabold shadow-sm"
                            onClick={loadMore}
                        ...
                        <Link href="/market/products">
                            <Button className="bg-[#B89968] text-white hover:bg-[#8C6F3F] rounded-[14px] font-extrabold shadow-sm">
                                Tüm Ürünleri Gör
                                <ArrowRight className="w-4 h-4 ml-2" />
                            </Button>
                        </Link>
