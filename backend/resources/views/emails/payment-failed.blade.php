...
<head>
    ...
    <title>Ödeme Başarısız — i-Bijuteri</title>
    <style>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <h2 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#1a1a1a;">
                                Sayın {{ $order->user->pharmacy_name ?? $order->user->name ?? 'Değerli Müşterimiz' }},
                            </h2>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="padding:8px 0 24px;">
                                        <a href="https://i-bijuteri.com/market/hesabim?tab=siparislerim" target="_blank" style="display:inline-block;background:#0390b1;color:#ffffff;padding:16px 40px;text-decoration:none;border-radius:8px;font-size:16px;font-weight:700;letter-spacing:0.3px;">
                                            Tekrar Dene
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#9ca3af;text-align:center;">
                                Sorun devam ederse <a href="mailto:info@i-bijuteri.com" style="color:#0390b1;text-decoration:none;font-weight:600;">info@i-bijuteri.com</a> adresinden destek alabilirsiniz.
                            </p>
