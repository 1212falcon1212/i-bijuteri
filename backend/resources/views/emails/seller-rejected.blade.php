...
<head>
    ...
    <title>Başvuru Durumu — i-Bijuteri</title>
    <style>
...
<body style="margin:0;padding:0;background-color:#f0fdfa;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    <div style="display:none;font-size:1px;color:#f0fdfa;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
        i-Bijuteri üyelik başvurunuz hakkında bilgilendirme. Lütfen detayları inceleyiniz.
    </div>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <p style="margin:0 0 12px;font-size:15px;line-height:1.7;color:#6b7280;">
                                i-Bijuteri üyelik başvurunuz incelendi.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="padding:8px 0 24px;">
                                        <a href="mailto:info@i-bijuteri.com" style="display:inline-block;background:#0390b1;color:#ffffff;padding:16px 40px;text-decoration:none;border-radius:8px;font-size:16px;font-weight:700;letter-spacing:0.3px;">
                                            Bize Ulaşın
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0;font-size:14px;line-height:1.6;color:#9ca3af;text-align:center;">
                                E-posta: <a href="mailto:info@i-bijuteri.com" style="color:#0390b1;text-decoration:none;font-weight:600;">info@i-bijuteri.com</a>
                            </p>
