...
<head>
    ...
    <title>Şifre Sıfırlama — i-Bijuteri</title>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;width:100%;">
                    ...
                    <tr>
                        <td align="center" style="background:linear-gradient(135deg,#0390b1,#027a96);padding:40px 40px 32px;border-radius:16px 16px 0 0;">
                            ...
                            <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.85);font-weight:400;">B2B Bijuteri Pazaryeri</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:40px;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;">
                            ...
                            <h2 style="margin:0 0 16px;font-size:22px;font-weight:700;color:#1a1a1a;">
                                Sayın {{ $user->pharmacy_name ?? $user->nickname ?? 'Değerli Üyemiz' }},
                            </h2>
                                ...
                                <tr>
                                    <td style="background:#f9fafb;border-radius:8px;padding:14px 20px;">
                                        <p style="margin:0;font-size:13px;line-height:1.6;color:#6b7280;">
                                            &#128272; Güvenlik notu: i-Bijuteri ekibi sizden asla e-posta ile şifrenizi istemez. Şüpheli bir durum fark ederseniz <a href="mailto:info@i-bijuteri.com" style="color:#0390b1;text-decoration:none;font-weight:600;">info@i-bijuteri.com</a> adresine bildiriniz.
                                        </p>
                                    </td>
                                </tr>
                            </table>
