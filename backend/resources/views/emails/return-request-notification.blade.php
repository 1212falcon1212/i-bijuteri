...
<head>
    ...
    <title>Yeni İade Talebi — i-Bijuteri</title>
    <style>
                                    ...
                                    <td style="background:#fef2f2;border:1px solid #fecaca;border-radius:12px;padding:20px 24px;">
                                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:6px 0;font-size:14px;font-weight:600;color:#1a1a1a;text-align:right;">{{ $returnRequest->buyer?->pharmacy_name ?? $returnRequest->buyer?->nickname ?? 'Alıcı' }}</td>
                                            </tr>
                                            <tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td align="center" style="padding:8px 0 24px;">
                                        <a href="https://i-bijuteri.com/market/hesabim?tab=siparislerim&sub=iade-talepleri" target="_blank" style="display:inline-block;background:#0390b1;color:#ffffff;padding:16px 40px;text-decoration:none;border-radius:8px;font-size:16px;font-weight:700;letter-spacing:0.3px;">
