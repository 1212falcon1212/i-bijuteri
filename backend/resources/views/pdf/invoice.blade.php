...
<div class="page">
    ...
    <div class="header">
        <div class="header-left">
            <div class="company-name">i-Bijuteri</div>
            <div class="company-subtitle">B2B Bijuteri Pazaryeri</div>
            <div class="company-subtitle" style="margin-top: 4px;">www.i-bijuteri.com</div>
        </div>
    ...
    <div class="parties">
        <div class="party party-seller">
            ...
            @if($seller)
                ...
                <div class="party-detail"><strong>Vergi No:</strong> {{ $seller->tax_number ?? '-' }}</div>
        ...
        <div class="party party-buyer">
            ...
            @if($buyer)
                ...
                <div class="party-detail"><strong>Vergi No:</strong> {{ $buyer->tax_number ?? '-' }}</div>
    ...
    {{-- Footer --}}
    <div class="footer">
        <div>Bu belge i-Bijuteri B2B Bijuteri Pazaryeri uzerinden otomatik olarak olusturulmustur.</div>
