...
<head>
    <meta charset="UTF-8">
    <title>Hakedis Raporu - {{ $seller->pharmacy_name ?? 'Satici' }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<div class="page">
    ...
    <div class="seller-info">
        ...
        <div class="seller-info-detail"><strong>Vergi No:</strong> {{ $seller->tax_number ?? '-' }}</div>
    ...
    {{-- Footer --}}
    <div class="footer">
        <div>Bu rapor i-Bijuteri B2B Bijuteri Pazaryeri uzerinden otomatik olarak olusturulmustur.</div>
