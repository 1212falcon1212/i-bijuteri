...
<body>
    ...
    <table class="info-table">
        <tr><td>İşletme / Şirket Adı</td><td>{{ $buyer_name }}</td></tr>
    ...
    <div class="footer">
        <p>Bu sözleşme {{ $date }} tarihinde i-Bijuteri B2B Bijuteri Pazaryeri üzerinden elektronik ortamda oluşturulmuştur.</p>
