...
Route::prefix('auth')->middleware('throttle:auth')->group(function () {
    ...
    Route::post('/verify-tax-number', [AuthController::class, 'verifyTaxNumber']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Seller offers (for companies to view pharmacy offers after link approval)
...
Route::prefix('cms')->middleware('cache.headers:600')->group(function () {
    ...
    Route::get('/pages-by-category/{category}', [\App\Http\Controllers\Api\CmsController::class, 'pagesByCategory']);
    Route::get('/pages/{slug}', [\App\Http\Controllers\Api\CmsController::class, 'page']);
});

// Backwards-compatible top-level shortcuts
Route::middleware('cache.headers:600')->group(function () {
    Route::get('/pages/{slug}', [\App\Http\Controllers\Api\CmsController::class, 'page']);
    Route::get('/pages-by-category/{category}', [\App\Http\Controllers\Api\CmsController::class, 'pagesByCategory']);
});
