...
class Category extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::saved(function ($category) {
            ...
            // Kategori değişikliklerinde tüm ilgili CMS cache'lerini temizle
            \Illuminate\Support\Facades\Cache::forget('cms.homepage.categories');
            \Illuminate\Support\Facades\Cache::forget('cms.homepage.featured_categories');
