...
class LegalController extends Controller
{
    ...
    public function downloadRegistrationContract(Request $request)
    {
        ...
        $commissionRate = match ($feeMode) {
            ...
            'category' => 'Kategori bazlı komisyon (güncel oranlar için www.i-bijuteri.com)',
            default => '-',
        };
...
<h4>1.1. Satıcı</h4>
<p><strong>Unvan:</strong> Platform üzerinde ilgili ürünü satışa sunan satıcı<br>
<strong>Platform:</strong> i-Bijuteri B2B Bijuteri Pazaryeri (www.i-bijuteri.com)<br>
<strong>E-posta:</strong> destek@i-bijuteri.com</p>
<h4>1.2. Alıcı</h4>
<p>Platform üzerinden sipariş veren ve doğrulaması tamamlanmış üye işletme.</p>

<h3>Madde 2 - Sözleşmenin Konusu</h3>
<p>İşbu sözleşmenin konusu, Alıcı'nın i-Bijuteri B2B Bijuteri Pazaryeri üzerinden elektronik ortamda siparişini verdiği ürün/ürünlerin satışı ve teslimine ilişkin olarak 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği hükümleri gereğince tarafların hak ve yükümlülüklerinin belirlenmesidir.</p>
...
<p>Alıcı, ürünün tesliminden itibaren 14 gün içinde cayma hakkını kullanabilir. Kişiselleştirilmiş/özel üretim ürünler, ambalajı açılmış hijyen ürünleri ile çabuk bozulabilir ürünlerde cayma hakkı kullanılamaz.</p>
...
<ul>
<li>Kişiselleştirilmiş veya özel üretim bijuteri ürünleri</li>
...
<p>İptal ve iade talepleriniz için: destek@i-bijuteri.com</p>
...
<h3>Madde 1 - Taraflar</h3>
<p>İşbu Sözleşme, i-Bijuteri B2B Bijuteri Pazaryeri ("Platform") ile üyelik başvurusunda bulunan ve doğrulaması tamamlanmış işletme ("Üye") arasında elektronik ortamda akdedilmiştir.</p>
...
<ul>
<li>Geçerli vergi numarasına sahip aktif bir işletme olmak</li>
<li>Vergi levhası ve faaliyet belgelerini sunmak</li>
