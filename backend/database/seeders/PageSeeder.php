    ...
    public function run(): void
    {
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 1,
                'meta_title' => 'Hakkımızda - i-depo.com',
                'meta_description' => 'i-depo.com hakkında bilgi edinin. Türkiye\'nin güvenilir B2B eczane tedarik platformu.',
                'excerpt' => 'Türkiye\'nin güvenilir B2B eczane tedarik platformu i-depo.com hakkında.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 2,
                'meta_title' => 'İletişim - i-depo.com',
                'meta_description' => 'i-depo.com ile iletişime geçin. Telefon, e-posta ve adres bilgilerimiz.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 10,
                'meta_title' => 'KVKK Aydınlatma Metni - i-depo.com',
                'meta_description' => 'i-depo.com KVKK aydınlatma metni. Kişisel verilerinizin korunması hakkında bilgilendirme.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 11,
                'meta_title' => 'Kullanım Koşulları - i-depo.com',
                'meta_description' => 'i-depo.com platform kullanım koşulları ve üyelik şartları.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 12,
                'meta_title' => 'Gizlilik Politikası - i-depo.com',
                'meta_description' => 'i-depo.com gizlilik politikası. Verilerinizin nasıl toplandığı ve korunduğu hakkında bilgi.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 13,
                'meta_title' => 'Çerez Politikası - i-depo.com',
                'meta_description' => 'i-depo.com çerez politikası. Web sitemizde kullanılan çerezler hakkında bilgi.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 14,
                'meta_title' => 'Mesafeli Satış Sözleşmesi - i-depo.com',
                'meta_description' => 'i-depo.com mesafeli satış sözleşmesi. B2B eczane pazaryeri üzerinden gerçekleştirilen satışlara ilişkin yasal sözleşme.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 15,
                'meta_title' => 'İptal ve İade Koşulları - i-depo.com',
                'meta_description' => 'i-depo.com iptal ve iade koşulları. Sipariş iptali, ürün iadesi ve cayma hakkı hakkında bilgilendirme.',
        ...
        Page::updateOrCreate(
            ...
            [
                ...
                'status' => 'published',
                'sort_order' => 16,
                'meta_title' => 'Üyelik Sözleşmesi - i-depo.com',
                'meta_description' => 'i-depo.com üyelik sözleşmesi. B2B eczane pazaryeri üyelik koşulları ve tarafların hak ve yükümlülükleri.',
...
<p>i-depo.com olarak eczaneler arasında güvenli, hızlı ve şeffaf bir ticaret ortamı sunuyoruz. Platformumuz, eczanelerin ihtiyaç duydukları ürünlere en uygun fiyatlarla ulaşmasını sağlar.</p>
...
<h3>Vizyonumuz</h3>
<p>Türkiye'nin en büyük ve en güvenilir B2B eczane tedarik platformu olmak. Teknoloji ile sektörü dönüştürerek eczanelerin iş süreçlerini kolaylaştırmak.</p>

<h3>Neden i-depo.com?</h3>
<ul>
...
<h3>Rakamlarla i-depo.com</h3>
<p>Platformumuz her geçen gün büyümeye ve eczanelere daha iyi hizmet vermeye devam ediyor. Binlerce eczanenin güvenle tercih ettiği i-depo.com ile siz de yerinizi alın.</p>
...
<li><strong>E-posta:</strong> info@i-depo.com</li>
...
<p>i-Depo B2B Eczane Pazaryeri ("Platform") olarak, 6698 sayılı Kişisel Verilerin Korunması Kanunu ("KVKK") kapsamında veri sorumlusu sıfatıyla, kişisel verilerinizin işlenmesine ilişkin sizi bilgilendirmek istiyoruz.</p>

<h3>1. Veri Sorumlusu</h3>
<p>Kişisel verileriniz, veri sorumlusu olarak i-Depo B2B Eczane Pazaryeri tarafından aşağıda açıklanan kapsamda işlenmektedir.</p>
...
<h3>7. Başvuru</h3>
<p>Haklarınıza ilişkin taleplerinizi <strong>destek@i-depo.com</strong> adresine iletebilirsiniz. Başvurularınız en geç 30 gün içinde sonuçlandırılacaktır.</p>
...
<p>i-Depo B2B Eczane Pazaryeri platformunu ("Platform") kullanarak bu kullanım koşullarını kabul etmiş sayılırsınız. Platform, yalnızca GLN (Global Location Number) doğrulaması yapılmış eczaneler tarafından kullanılabilir.</p>
...
<h3>1. Giriş</h3>
<p>i-Depo B2B Eczane Pazaryeri olarak kişisel verilerinizin güvenliği bizim için önemlidir. Bu gizlilik politikası, hangi verileri topladığımızı, nasıl kullandığımızı ve koruduğumuzu açıklar.</p>
...
<h3>6. Haklarınız</h3>
<p>KVKK kapsamında verilerinize erişim, düzeltme, silme ve taşınabilirlik haklarına sahipsiniz. Başvurularınızı <strong>destek@i-depo.com</strong> adresine iletebilirsiniz.</p>
...
<strong>Platform:</strong> i-Depo B2B Eczane Pazaryeri (www.i-depo.com)<br>
<strong>E-posta:</strong> destek@i-depo.com</p>
...
<p>7.2. Cayma hakkının kullanılabilmesi için bu süre içinde Platform üzerinden veya destek@i-depo.com adresine yazılı bildirimde bulunulması gerekmektedir.</p>
...
<p>i-Depo B2B Eczane Pazaryeri ("Platform") üzerinden gerçekleştirilen alışverişlere ilişkin iptal ve iade koşulları, 6502 sayılı Tüketicinin Korunması Hakkında Kanun, Mesafeli Sözleşmeler Yönetmeliği ve ilgili mevzuat hükümleri çerçevesinde aşağıda düzenlenmiştir.</p>

<h3>Madde 2 - Sipariş İptali</h3>
<p>2.1. Alıcı, siparişin kargoya verilmesine kadar geçen süre içinde siparişini iptal edebilir. İptal talebi, Platform üzerindeki "Siparişlerim" bölümünden veya destek@i-depo.com adresine e-posta göndererek yapılabilir.</p>
...
<li>Platform üzerinden veya destek@i-depo.com adresine yazılı bildirimde bulunulmalıdır.</li>
</ul>
...
<ul>
<li><strong>E-posta:</strong> destek@i-depo.com</li>
...
<p><strong>Platform İşletmecisi:</strong> i-Depo B2B Eczane Pazaryeri (www.i-depo.com) ("Platform")<br>
<strong>E-posta:</strong> destek@i-depo.com</p>
...
<ul>
<li><strong>Platform:</strong> www.i-depo.com alan adı üzerinden erişilebilen B2B eczane pazaryeri.</li>
